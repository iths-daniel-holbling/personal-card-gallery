...
leftButton.addEventListener("click", function(event){
    if(userDataRow == 0){
        userDataRow = parsedData.results.length-1
    }else{
        userDataRow--;
    }
    loadUserData()
